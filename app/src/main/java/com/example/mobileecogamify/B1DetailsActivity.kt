...
class B1DetailsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_b1_details)
        ...
        joinButton.setOnClickListener(object : View.OnClickListener {
            override fun onClick(view: View?) {
                ...
                // Create an intent to navigate to OceanCollectorActivity
                val intent = Intent(applicationContext, OceanCollectorActivity::class.java)


                // Start OceanCollectorActivity
