...
class NewChallenge : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = NewChallengeAdapter(emptyList(), ::deleteChallenge, ::updateChallenge)
    ...
    private fun updateChallenge(challenge: ChallengeData) {
        // Handle the update functionality here, e.g., open an editing screen
        // You can pass the selected challenge data to another activity or fragment for editing
        val intent = Intent(this, EditChallengeActivity::class.java)

        // Pass the selected challenge data to the editing screen
